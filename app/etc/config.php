...
return [
    'modules' => [
        ...
        'Amazon_Login' => 0,
        'Amazon_Payment' => 0,
        'Codifi_AddressType' => 1,
        'Codifi_AdminCustomPage' => 1,
        'Codifi_BlogPostWidget' => 1,
        'Codifi_CustomAddressType' => 1,
        'Codifi_CustomWidget' => 1,
        'Codifi_CustomerRequest' => 1,
        'Codifi_DeliveryDate' => 1,
        'Codifi_FirstStepCheckout' => 1,
        'Codifi_OptionConfigurableProduct' => 1,
        'Codifi_OrderConfirmation' => 1,
        'Codifi_OutOfStockNotification' => 1,
        'Codifi_ProductAttributePopup' => 1,
        'Codifi_SecondStepCheckout' => 1,
        'Codifi_ShippingDropdown' => 1,
        'Codifi_ShippingInstructions' => 1,
        'Codifi_SystemMessage' => 1,
        'Codifi_TestModule' => 1,
        'Codifi_UiComponents' => 1,
        'Codifi_UpdateConfigDataPatch' => 1,
        'Codifi_ValidationRule' => 1,
        'Codifi_ValidationRuleShippingAddress' => 1,
